...
public interface RetrofitApi {
    ...
    @GET("3/search/movie")
    Call<MoviesSearch> getMovieSearchResult(@Query("api_key") String apiKey,
                                            @Query("query") String query,
                                            @Query("language") String language,
                                            @Query("page") int page_number);

    @GET("3/search/tv")
    Call<TvShowSearch> getTvSearchResult(@Query("api_key") String apiKey,
                                         @Query("query") String query,
                                         @Query("language") String language,
                                         @Query("page") int page_number);

    @GET("3/search/person")
    Call<ActorSearch> getActorSearchResult(@Query("api_key") String apiKey,
                                           @Query("language") String language,
                                           @Query("query") String query,
                                           @Query("page") int page_number);
}
